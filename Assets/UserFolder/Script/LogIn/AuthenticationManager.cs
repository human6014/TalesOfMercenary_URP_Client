...
public class AuthenticationManager : MonoBehaviour
{
   ...
   private const string AppClientID = "ti61phla3e4ect3un7ufmuij0"; // App client ID, found under App Client Settings
   private const string AuthCognitoDomainPrefix = "taleofmercenary"; // Found under App Integration -> Domain Name. Changing this means it must be updated in all linked Social providers redirect and javascript origins
